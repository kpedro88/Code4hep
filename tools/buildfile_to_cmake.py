...
Single-file mode:
    BUILDFILE           Absolute path to BuildFile.xml. Defaults to ./BuildFile.xml.

Scan-dir mode (--scan-dir DIR):
    Recursively converts every BuildFile.xml found under absolute path DIR.
    Also:
...
Options:
    ...
    --scan-dir DIR      Convert all BuildFile.xml files under absolute path DIR
                        (recursive).
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Scan-dir mode (--scan-dir DIR):
  Converts every BuildFile.xml found recursively under absolute path DIR.
  Additionally:
...
""",
    ...
    parser.add_argument(
        ...
        metavar="BUILDFILE",
        help=(
            "Absolute path to BuildFile.xml (default: ./BuildFile.xml). "
    ...
    parser.add_argument(
        ...
        metavar="DIR",
        help=(
            "Convert all BuildFile.xml files found recursively under absolute path DIR and "
