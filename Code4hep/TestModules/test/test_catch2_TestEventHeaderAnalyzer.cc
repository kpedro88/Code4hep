...
static constexpr auto s_tag = "[TestEventHeaderAnalyzer]";

TEST_CASE("Standard checks of TestEventHeaderAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
from Code4hep.TestModules.modules import c4h_TestEventHeaderAnalyzer
process.toTest = c4h_TestEventHeaderAnalyzer(
